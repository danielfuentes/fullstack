...
if($_POST){
    ...
    if(count($errors) == 0) {
        $avatar=uploadPhoto($_FILES);   
        $usuario=createUser($_POST, $avatar);
        saveUser($usuario);
       
        //Una vez que determinemos que todo esta bien, entonces procedemos a redireccionar al usuario a otro lugar, puede ser al login para que ingrese a nuestra página, o enviarlo a un menú del sistema, a donde nosotros querramos.
...
<html>
    <head>
        ...
        <title>Validación - Json - Foto </title>
