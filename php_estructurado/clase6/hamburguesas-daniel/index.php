...
<!--Aquí verifico a ver si el usuario envio o no
...
<html lang="es">
	...
	<body id="top">
        ...
        <section id="services">	
            <?php include_once('plantillas/servicios.php');?>
        ...
        <section id="promos">
            <div class="container">
                <?php include_once('plantillas/promociones.php');?>                
            </div>
        </section>
		...
		<section id="about">
			<div class="container">
                <?php include_once('plantillas/nosotros.php');?>                				
			</div>
		</section>
		...
		<section id="contact">
			<div class="container">
			    <?php include_once('plantillas/contacto.php');?>                					
			</div>
		</section>
		...
		<!--Pendientes mis amigos, aquí hay librerias que no deben utilizar 
		...
		Boostrap
		Le quite el llamado a jquery para que no me interfiera
		cada vez que valido
