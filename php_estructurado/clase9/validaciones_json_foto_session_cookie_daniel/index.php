...
<?php
//Antes de programar cualquier otra cosa debo atrapar la sessión
...
if ($_POST) {
    ...
    if(count($errores)==0){
        ...
        //Aquí incorporo la creación mi variable de session
        include_once("funciones/controlador_sessiones.php");
        //Aquí incorporo la creación mi variable de cookie
        include_once("funciones/controlador_cookie.php");
...
<html lang="es">
    ...
    <body>
        <form action="" method="POST" enctype="multipart/form-data" >
            ...
            <!--Si quisiera subir mas de una foto debe hacer el input así-->
